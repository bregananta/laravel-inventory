...
class InventoryStockTest extends InventoryTest
{
    ...
    public function testInvalidMovementException()
    {
        ...
        $this->setExpectedException('Bregananta\Inventory\Exceptions\InvalidMovementException');
    ...
    public function testNotEnoughStockException()
    {
        ...
        $this->setExpectedException('Bregananta\Inventory\Exceptions\NotEnoughStockException');
    ...
    public function testInventoryInvalidLocationException()
    {
        ...
        $this->setExpectedException('Bregananta\Inventory\Exceptions\InvalidLocationException');
    ...
    public function testInventoryStockNewTransaction()
    {
        ...
        $this->assertInstanceOf('Bregananta\Inventory\Interfaces\StateableInterface', $transaction);
    }
}
